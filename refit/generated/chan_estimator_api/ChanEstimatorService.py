...
class Client(Iface):
    ...
    def retrieveEst(self, eMu, eMuX, eMuEma, eNu1, eNu2, qMu, qNu1, qNu2, maintenance):
        ...
        """
        self.send_retrieveEst(eMu, eMuX, eMuEma, eNu1, eNu2, qMu, qNu1, qNu2, maintenance)
        return self.recv_retrieveEst()

    def send_retrieveEst(self, eMu, eMuX, eMuEma, eNu1, eNu2, qMu, qNu1, qNu2, maintenance):
...
class Processor(Iface, TProcessor):
    ...
    def process_retrieveEst(self, seqid, iprot, oprot):
        ...
        result = retrieveEst_result()
        try:
            result.success = self._handler.retrieveEst(args.eMu, args.eMuX, args.eMuEma, args.eNu1, args.eNu2, args.qMu, args.qNu1, args.qNu2, args.maintenance)
...
class retrieveEst_args(object):
    ...
    def __init__(self, eMu=None, eMuX=None, eMuEma=None, eNu1=None, eNu2=None, qMu=None, qNu1=None, qNu2=None, maintenance=None,):
        self.eMu = eMu
        self.eMuX = eMuX
        self.eMuEma = eMuEma
        self.eNu1 = eNu1
    ...
    def write(self, oprot):
        ...
        if self.eMu is not None:
            ...
            oprot.writeFieldEnd()
        if self.eMuX is not None:
            oprot.writeFieldBegin('eMuX', TType.DOUBLE, 2)
            oprot.writeDouble(self.eMuX)
            oprot.writeFieldEnd()
        if self.eMuEma is not None:
            oprot.writeFieldBegin('eMuEma', TType.DOUBLE, 3)
            oprot.writeDouble(self.eMuEma)
            oprot.writeFieldEnd()
        if self.eNu1 is not None:
            oprot.writeFieldBegin('eNu1', TType.DOUBLE, 4)
            oprot.writeDouble(self.eNu1)
            oprot.writeFieldEnd()
        if self.eNu2 is not None:
            oprot.writeFieldBegin('eNu2', TType.DOUBLE, 5)
            oprot.writeDouble(self.eNu2)
            oprot.writeFieldEnd()
        if self.qMu is not None:
            oprot.writeFieldBegin('qMu', TType.DOUBLE, 6)
            oprot.writeDouble(self.qMu)
            oprot.writeFieldEnd()
        if self.qNu1 is not None:
            oprot.writeFieldBegin('qNu1', TType.DOUBLE, 7)
            oprot.writeDouble(self.qNu1)
            oprot.writeFieldEnd()
        if self.qNu2 is not None:
            oprot.writeFieldBegin('qNu2', TType.DOUBLE, 8)
            oprot.writeDouble(self.qNu2)
            oprot.writeFieldEnd()
        if self.maintenance is not None:
            oprot.writeFieldBegin('maintenance', TType.BOOL, 9)
...
retrieveEst_args.thrift_spec = (
    ...
    (2, TType.DOUBLE, 'eMuX', None, None, ),  # 2
    (3, TType.DOUBLE, 'eMuEma', None, None, ),  # 3
    (4, TType.DOUBLE, 'eNu1', None, None, ),  # 4
    (5, TType.DOUBLE, 'eNu2', None, None, ),  # 5
    (6, TType.DOUBLE, 'qMu', None, None, ),  # 6
    (7, TType.DOUBLE, 'qNu1', None, None, ),  # 7
    (8, TType.DOUBLE, 'qNu2', None, None, ),  # 8
    (9, TType.BOOL, 'maintenance', None, None, ),  # 9
)
